...
status_bars = ttk.Label(window,text = "Cow IDE python \t\t\t\t\t\t characters: 0 words: 0")
status_bars.pack(side = BOTTOM)
text_change = False
def change_word(event = None):
    ...
    if editor.edit_modified():
        ...
        status_bars.config(text = f"Cow IDE python \t\t\t\t\t\t characters: {chararcter} words: {word}")
